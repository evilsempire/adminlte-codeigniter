...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST) {
    ...
    if ($core->checkEmpty($_POST) == true) {
        ...
        } else if ($core->write_constant($_POST) == false) {
            $message = $core->show_message('error', "The constants configuration file could not be written, please chmod application/config/constants.php file to 777");
        }
            ...
            ?>
                ...
                <form id="install_form" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                    <div class="form-group">
                        <label for="hostname">Application Name</label>
                        <input type="text" id="site_name" class="form-control" name="site_name" />
                        <p class="help-block">for example: Adminlte.</p>
                    </div>
                    <div class="form-group">
